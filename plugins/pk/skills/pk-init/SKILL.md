---
name: pk-init
description: Use when the user wants to initialize `.repowise/` for the current local project.
---
...
- Report the result in Chinese and include the project root, the `.repowise/` path, Obsidian entry files (`index.md`, `log.md`, `_views/`), and suggested next skills `pk-status` and `pk-graph`.
